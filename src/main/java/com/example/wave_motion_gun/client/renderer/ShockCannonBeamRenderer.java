...
public class ShockCannonBeamRenderer extends EntityRenderer<ShockCannonBeam> {
    ...
    public ShockCannonBeamRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(ShockCannonBeam entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        ...
        BeamGeometryHelper.drawSubdividedSegment(poseStack, vertexBuilder, relStart, Vec3.ZERO,
                ...
                0.5f, fullBright, absTime, -1.0f, 0.5f, phaseTail, phaseHead);
    ...
    @Override
    public boolean shouldRender(ShockCannonBeam entity, Frustum frustum, double camX, double camY, double camZ) {
    ...
    @Override
    public ResourceLocation getTextureLocation(ShockCannonBeam entity) {
        return BEAM_TEXTURE;
    }
}
