...
import com.example.wave_motion_gun.entity.WaveBeamSegment;
...
public class WaveBeamSegmentRenderer extends EntityRenderer<WaveBeamSegment> {
    ...
    public WaveBeamSegmentRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public boolean shouldRender(WaveBeamSegment entity, Frustum frustum, double camX, double camY, double camZ) {
        // 基本的な距離チェック
    ...
    @Override
    public void render(WaveBeamSegment entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        ...
        float baseRadius = entity.getRadius() / 2.0f;
        ...
        // 内側 (Inner)
        BeamGeometryHelper.drawSubdividedSegment(poseStack, vertexBuilder, Vec3.ZERO, endDelta, baseRadius * 0.4f,
        ...
        BeamGeometryHelper.drawSubdividedSegment(poseStack, vertexBuilder, Vec3.ZERO, endDelta, baseRadius,
                ...
                alpha * 0.5f, fullBright, absTime, -0.3f, 0.5f, phaseStart, phaseEnd);
    ...
    @Override
    public ResourceLocation getTextureLocation(WaveBeamSegment entity) { return BEAM_TEXTURE; }
}
