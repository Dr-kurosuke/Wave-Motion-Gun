...
public class MessengerScreen extends Screen {
    ...
    public MessengerScreen(MessengerEntity entity) {
        super(new TranslatableComponent("gui.wave_motion_gun_mod.messenger.title"));
        this.entity = entity;
    }
    ...
    private void refreshQuestion() {
        ...
        if (qIdx >= 0 && qIdx < questions.size()) {
            ...
            for (int i = 0; i < currentQuestion.options.length; i++) {
                ...
                this.addRenderableWidget(new Button(centerX - 100, centerY + 20 + (i * 25), 200, 20,
                        new TranslatableComponent(currentQuestion.options[i]), (btn) -> {
                    sendAnswer(index);
                }));
            }
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        switch (mode) {
            case AI_CONNECTING -> {
                drawCenteredString(poseStack, this.font, I18n.get("gui.wave_motion_gun_mod.ai.connecting"),
            ...
            case AI_UNAVAILABLE -> drawCenteredString(poseStack, this.font,
            ...
            default -> {
                if (currentQuestion != null) {
                    ...
                    drawCenteredString(poseStack, this.font, header, centerX, centerY - 60, 0x00FFFF);

                    if (showFallbackNotice) {
                        drawCenteredString(poseStack, this.font, I18n.get("gui.wave_motion_gun_mod.ai.fallback"),
                    ...
                    for (int i = 0; i < lines.size(); i++) {
                        ...
                        this.font.drawShadow(poseStack, line,
                                centerX - this.font.width(line) / 2f, startY + (i * 10), 0xFFFFFF);
                    }
                }
            }
        }
