...
public class ClientEvents {
    ...
    @SubscribeEvent
    public static void onLoggedOut(net.minecraftforge.client.event.ClientPlayerNetworkEvent.LoggedOutEvent event) {
    ...
    public static void onRenderGameOverlay(RenderGameOverlayEvent.Post event) {
        ...
        if (!arrived) {
            ...
            font.drawShadow(event.getMatrixStack(), cachedCurrentText, x, y - 10, 0xFFFFFF);
        }

        font.drawShadow(event.getMatrixStack(), coordText, x, y, 0xFFFFFF);
        font.drawShadow(event.getMatrixStack(), timeText, x, y + 10, 0xFFFFFF);
    }
}