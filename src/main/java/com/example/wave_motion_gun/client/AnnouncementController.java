...
public class AnnouncementController {
    ...
    public interface TextDrawer {
        void draw(PoseStack poseStack, String text, float x, float y, int color);
    }
    ...
    public void renderAnnouncements(PoseStack poseStack, long now, TextDrawer drawer) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            for (String line : msg.split("\n")) {
                ...
                drawer.draw(poseStack, line, VirtualScaledScreen.VIRTUAL_WIDTH / 2, cursorY, fullColor);
                cursorY += lineHeight;
            }
        }
    }
