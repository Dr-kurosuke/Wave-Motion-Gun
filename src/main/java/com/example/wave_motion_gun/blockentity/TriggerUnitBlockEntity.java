...
public class TriggerUnitBlockEntity extends BlockEntity implements MenuProvider {
    ...
    public void load(CompoundTag tag) {
        ...
        this.targetFrequency = net.minecraft.util.Mth.clamp(this.targetFrequency, 0, FrequencyManager.MAX_FREQUENCY);
    ...
    public Component getDisplayName() {
        return net.minecraft.network.chat.Component.translatable("container.wave_motion_gun_mod.trigger_unit");
    }
