...
public class WaveBeamSegment extends AbstractBeamSegment {
    ...
    protected void serverTick() {
        ...
        if (this.damageValue > 0 && this.tickCount % 10 == 0) {
            ...
            net.minecraft.world.damagesource.IndirectEntityDamageSource damageSource =
                    new net.minecraft.world.damagesource.IndirectEntityDamageSource("wave_motion_gun", this, null);
