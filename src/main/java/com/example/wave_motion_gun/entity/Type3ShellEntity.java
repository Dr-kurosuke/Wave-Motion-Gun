...
public class Type3ShellEntity extends AbstractHurtingProjectile implements ItemSupplier {
    ...
    protected void onHit(HitResult result) {
        ...
        if (!this.level.isClientSide) {
            ...
            this.level.explode(this, this.getX(), this.getY(), this.getZ(), radius, Explosion.BlockInteraction.BREAK);
            ...
            // ダメージソース作成 (爆発属性)
            DamageSource damageSource = new IndirectEntityDamageSource("explosion", this, this.getOwner()).setExplosion();
