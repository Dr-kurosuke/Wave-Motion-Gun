...
import net.minecraft.world.damagesource.IndirectEntityDamageSource; // ■ 追加
...
public class WaveCartridgeEntity extends AbstractHurtingProjectile implements ItemSupplier {
            ...
            if (!this.level.isClientSide) {
                ...
                if (this.impactTicks % 10 == 1) {
                    ...
                    if (this.impactDamageSource == null) {
                        this.impactDamageSource = new IndirectEntityDamageSource("explosion", this, this.getOwner()).setExplosion();
                    }
    ...
    protected void onHit(HitResult result) {
        ...
        if (!this.level.isClientSide) {
            ...
            this.level.explode(this, this.getX(), this.getY(), this.getZ(), EXPLOSION_RADIUS, Explosion.BlockInteraction.NONE);
