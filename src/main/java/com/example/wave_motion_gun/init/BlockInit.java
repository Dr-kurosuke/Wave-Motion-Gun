...
public class BlockInit {
    ...
    public static final RegistryObject<Block> WAVE_CANNON = BLOCKS.register("wave_cannon",
            () -> new WaveCannonBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(2.0f).sound(SoundType.METAL).noOcclusion()));

    public static final RegistryObject<Block> WAVE_ENERGY_STORAGE = BLOCKS.register("wave_energy_storage",
            () -> new WaveEnergyStorageBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(2.0f).sound(SoundType.METAL).noOcclusion()));

    public static final RegistryObject<Block> MONITORING_UNIT = BLOCKS.register("monitoring_unit",
            () -> new MonitoringUnitBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(2.0f).sound(SoundType.METAL).noOcclusion()));

    public static final RegistryObject<Block> BARREL_UNIT = BLOCKS.register("barrel_unit",
            () -> new BarrelUnitBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(2.0f).sound(SoundType.METAL).noOcclusion()));

    public static final RegistryObject<Block> TRIGGER_UNIT = BLOCKS.register("trigger_unit",
            () -> new TriggerUnitBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).strength(2.0f).sound(SoundType.METAL).noOcclusion()));

    public static final RegistryObject<Block> DECORATION_COVER = BLOCKS.register("decoration_cover",
            () -> new DecorationCoverBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL)
                    .strength(2.0f)
    ...
    public static final RegistryObject<Block> SEAT_BLOCK = BLOCKS.register("seat_block",
            () -> new SeatBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE)
                    .strength(2.0f)
                    .sound(SoundType.METAL)
                    .noOcclusion()
            ));
    ...
    public static final RegistryObject<Block> TACHYON_PARTICLE_COMPRESSOR = BLOCKS.register("tachyon_particle_compressor",
            () -> new WaveMachineBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL)
                    .strength(2.0f)
                    .sound(SoundType.METAL)
                    .noOcclusion()));
    ...
    public static final RegistryObject<Block> SUPPLY_CRATE = BLOCKS.register("supply_crate",
            () -> new SupplyCrateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL)
    ...
    // 衝撃砲 台座 (硬さは波動砲の砲身と同じ2.0に揃える)
    public static final RegistryObject<Block> SHOCK_CANNON = BLOCKS.register("shock_cannon",
            () -> new ShockCannonBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(2.0f).noOcclusion()));

    // 衝撃砲 砲身 (硬さは波動砲の砲身と同じ2.0に揃える)
    public static final RegistryObject<Block> SHOCK_CANNON_BARREL = BLOCKS.register("shock_cannon_barrel",
            () -> new ShockCannonBarrelBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(2.0f).noOcclusion()));
