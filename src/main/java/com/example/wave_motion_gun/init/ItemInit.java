...
public class ItemInit {
    ...
    public static final RegistryObject<Item> WAVE_CANNON = ITEMS.register("wave_cannon",
            () -> new BlockItem(BlockInit.WAVE_CANNON.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    public static final RegistryObject<Item> TRIGGER_UNIT = ITEMS.register("trigger_unit",
            () -> new BlockItem(BlockInit.TRIGGER_UNIT.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    public static final RegistryObject<Item> MONITORING_UNIT = ITEMS.register("monitoring_unit",
            () -> new BlockItem(BlockInit.MONITORING_UNIT.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    public static final RegistryObject<Item> WAVE_ENERGY_STORAGE = ITEMS.register("wave_energy_storage",
            () -> new BlockItem(BlockInit.WAVE_ENERGY_STORAGE.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    public static final RegistryObject<Item> BARREL_UNIT = ITEMS.register("barrel_unit",
            () -> new BlockItem(BlockInit.BARREL_UNIT.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    public static final RegistryObject<Item> SEAT_BLOCK = ITEMS.register("seat_block",
            () -> new BlockItem(BlockInit.SEAT_BLOCK.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));
    ...
    public static final RegistryObject<Item> COMMUNICATION_BEACON = ITEMS.register("communication_beacon",
            () -> new BlockItem(BlockInit.COMMUNICATION_BEACON.get(),
                    new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    // --- 新規機械ブロック ---
    public static final RegistryObject<Item> TACHYON_PARTICLE_COMPRESSOR = ITEMS.register("tachyon_particle_compressor",
            () -> new BlockItem(BlockInit.TACHYON_PARTICLE_COMPRESSOR.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    public static final RegistryObject<Item> WAVELENGTH_ADJUSTER = ITEMS.register("wavelength_adjuster",
            () -> new BlockItem(BlockInit.WAVELENGTH_ADJUSTER.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    public static final RegistryObject<Item> WAVE_CHAMBER = ITEMS.register("wave_chamber",
            () -> new BlockItem(BlockInit.WAVE_CHAMBER.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    // --- 【追加】Supply Drop関連 ---

    // 座標データパッド: イベントアイテムなのでスタック不可
    public static final RegistryObject<Item> COORDINATE_DATAPAD = ITEMS.register("coordinate_datapad",
            () -> new CoordinateDatapadItem(new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB).stacksTo(1).rarity(Rarity.UNCOMMON)));

    // 補給コンテナ (アイテム版)
    public static final RegistryObject<Item> SUPPLY_CRATE = ITEMS.register("supply_crate",
            () -> new BlockItem(BlockInit.SUPPLY_CRATE.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB).rarity(Rarity.RARE)));


    // --- 素材・その他アイテム ---
    public static final RegistryObject<Item> RAW_COSMO_ORE = ITEMS.register("raw_cosmo_ore",
            () -> new Item(new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));
    ...
    public static final RegistryObject<Item> COSMO_STEEL = ITEMS.register("cosmo_steel",
            () -> new Item(new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB).rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> QUANTUM_UNIT = ITEMS.register("quantum_unit",
            () -> new Item(new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB).rarity(Rarity.RARE)));

    public static final RegistryObject<Item> WAVE_CORE = ITEMS.register("wave_core",
            () -> new Item(new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB).rarity(Rarity.EPIC).fireResistant()));
    ...
    public static final RegistryObject<Item> SHOCK_CANNON = ITEMS.register("shock_cannon",
            () -> new BlockItem(BlockInit.SHOCK_CANNON.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    // 衝撃砲 砲身（アイテム）
    public static final RegistryObject<Item> SHOCK_CANNON_BARREL = ITEMS.register("shock_cannon_barrel",
            () -> new BlockItem(BlockInit.SHOCK_CANNON_BARREL.get(), new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB)));

    // 衝撃砲弾（弾薬アイテム）
    public static final RegistryObject<Item> SHOCK_CANNON_SHELL = ITEMS.register("shock_cannon_shell",
            () -> new Item(new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB).stacksTo(16)));
    ...
    public static final RegistryObject<Item> WAVE_CARTRIDGE = ITEMS.register("wave_cartridge",
            () -> new Item(new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB).stacksTo(1)));

    // 波動砲 整備手帳(マニュアル)
    public static final RegistryObject<Item> WAVE_MANUAL = ITEMS.register("wave_manual",
            () -> new ManualItem(new Item.Properties().tab(CreativeTabInit.WAVE_CANNON_TAB).stacksTo(1),
